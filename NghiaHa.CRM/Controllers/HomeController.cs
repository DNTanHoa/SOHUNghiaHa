...
namespace NghiaHa.CRM.Controllers
{
    public class HomeController : Controller
    {
        ...
        public string InitializationMenuLeft()
        {
            ...
            txt.AppendLine(@"<i class='nav-icon fas fa-chart-line'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Báo cáo thống kê");
            txt.AppendLine(@"<i class='right fas fa-angle-left'></i>");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"<ul class='nav nav-treeview'>");
            txt.AppendLine(@"<li class='nav-item'>");
            txt.AppendLine(@"<a class='nav-link' href='/BaoCaoThongKe/ProjectCongNo'>");
            txt.AppendLine(@"<i class='nav-icon far fa-circle'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Dự án - Công nợ");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"<li class='nav-item'>");
            txt.AppendLine(@"<a class='nav-link' href='/BaoCaoThongKe/HoaDonXuatHangCongNo'>");
            txt.AppendLine(@"<i class='nav-icon far fa-circle'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Xuất hàng - Công nợ");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"<li class='nav-item'>");
            txt.AppendLine(@"<a class='nav-link' href='/BaoCaoThongKe/HoaDonNhapHangCongNo'>");
            txt.AppendLine(@"<i class='nav-icon far fa-circle'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Nhập hàng - Công nợ");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"</li>");            
            txt.AppendLine(@"<li class='nav-item'>");
            txt.AppendLine(@"<a class='nav-link' href='/BaoCaoThongKe/ProductTonKho'>");
            txt.AppendLine(@"<i class='nav-icon far fa-circle'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Vật tư - Tồn kho");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"</ul>");
            ...
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"<li class='nav-item'>");
            txt.AppendLine(@"<a class='nav-link' href='/Invoice/BanLe'>");
            txt.AppendLine(@"<i class='nav-icon far fa-circle'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Bán lẻ");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"<li class='nav-item'>");
            ...
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"<li class='nav-item'>");
            txt.AppendLine(@"<a class='nav-link' href='/BaoCaoThongKe/BanLe'>");
            txt.AppendLine(@"<i class='nav-icon far fa-circle'></i>");
            txt.AppendLine(@"<p>");
            txt.AppendLine(@"Bán lẻ - Tháng");
            txt.AppendLine(@"</p>");
            txt.AppendLine(@"</a>");
            txt.AppendLine(@"</li>");
            txt.AppendLine(@"</ul>");
