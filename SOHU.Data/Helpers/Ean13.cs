...
namespace SOHU.Data.Helpers
{
    public class Ean13
    {
        ...
        private float _fMaximumAllowableScale = 10.0f;
        ...
        public Ean13()
        {
            _sCountryCode = AppGlobal.EAN13CountryCode;
            _sManufacturerCode = AppGlobal.EAN13ManufacturerCode;
        }
        ...
        public System.Drawing.Bitmap CreateBitmap()
        {
            ...
            float tempWidth = 1200;
            float tempHeight = 800;
        ...
        public static string CreateEAN13Image(string ProductCode, string DuongDanTapTin)
        {
            Ean13 ean13 = new Ean13();
            ean13.ProductCode = ProductCode;
            ean13.Scale = 8;
            System.Drawing.Bitmap bmp = ean13.CreateBitmap();
            string fileName = ean13.CountryCode + ean13.ManufacturerCode + ProductCode + ean13.ChecksumDigit + ".png";
            DuongDanTapTin = DuongDanTapTin + fileName;
            bmp.Save(DuongDanTapTin, ImageFormat.Png);
            return fileName;
        }
        public static string CreateEAN13Image_Product(Product model, string path)
        {
            bool equals = false;
            ...
            ean13.ProductCode = model.MetaTitle.Substring(8, 4);
            ean13.Scale = 8;
            System.Drawing.Bitmap bmp = ean13.CreateBitmap();
        ...
        public static string CreateEAN13Image01(Ean13 ean13, string DuongDanTapTin)
        {
            ean13.Scale = 8;
            System.Drawing.Bitmap bmp = ean13.CreateBitmap();
            string fileName = ean13.CountryCode + ean13.ManufacturerCode + ean13.ProductCode + ean13.ChecksumDigit + ".png";
            DuongDanTapTin = DuongDanTapTin + fileName;
            bmp.Save(DuongDanTapTin, ImageFormat.Png);
            return fileName;
        }
